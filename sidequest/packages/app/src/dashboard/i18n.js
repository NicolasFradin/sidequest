...
const TRANSLATIONS = {
  fr: {
    ...
    "plans.generateModal.mascotLabel": "Mascotte (optionnel)",
    "plans.generateModal.mascotHint": "Décris la mascotte que tu imagines — l'IA proposera une idée en texte, à choisir ensuite dans l'éditeur (aucune image n'est générée).",
    "plans.generateModal.mascotPlaceholder": "Ex : un petit robot bricoleur, rond, orange et gris",
...
La mascotte est optionnelle.`,
    ...
    "planEditor.aiMascotIdea": (idea) => `💡 Idée de mascotte suggérée par l'IA : « ${idea} »`,
  ...
  en: {
    ...
    "plans.generateModal.mascotLabel": "Mascot (optional)",
    "plans.generateModal.mascotHint": "Describe the mascot you're picturing — the AI will suggest a text idea, to pick from in the editor afterward (no image is generated).",
    "plans.generateModal.mascotPlaceholder": "E.g.: a small handyman robot, round, orange and grey",
...
The mascot is optional.`,
    ...
    "planEditor.aiMascotIdea": (idea) => `💡 AI-suggested mascot idea: "${idea}"`,
