...
3. **Sprint 3 (planned)** — Packs gallery in the dashboard (3.3).
4. **Sprint 4 (planned)** — XP bar, `pack_progress` table, mascot growth stages, SideCat/SideTama example packs (3.4).
